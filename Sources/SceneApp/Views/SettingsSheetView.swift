    ...
    private func variableHelpItems(for category: PromptCategory) -> [PromptVariableItem] {
        ...
        case .prose:
            return [
                ...
                .init(token: "{{output_profile_block}}", meaning: "Resolved output constraints block (tone/style/length/temperature) for prose generation."),
                .init(token: "{{output_tone}} / {{output_style}} / {{output_length}}", meaning: "Resolved output profile fields for the current scene (falling back to project defaults)."),
                .init(token: "{{output_tone_custom}} / {{output_style_custom}}", meaning: "Optional raw custom tone/style values after scene override fallback."),
                ...
                .init(token: "{{auto_project_memory}} / {{auto_chapter_memory}} / {{auto_scene_memory}}", meaning: "Structured auto-extracted story memory at project, chapter, and scene scope."),
                .init(token: "{{story_knowledge}}", meaning: "Relevant project knowledge graph neighborhood for the current scene/chapter."),
